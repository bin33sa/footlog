...
<head>
    ...
    <style>
        /* 기존 스타일 유지 */
        .gallery-img-wrapper { position: relative; width: 100%; padding-top: 66.66% !important; overflow: hidden; background-color: #f8f9fa; }
        .gallery-card .card-title { display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-size: 0.9rem !important; }
        .gallery-card:hover .gallery-img-wrapper img { transform: scale(1.08); transition: transform 0.4s ease; }
        ...
        .page-navigation b { background-color: #111; color: #D4F63F !important; width: 38px; height: 38px; display: inline-flex; align-items: center; justify-content: center; border-radius: 12px; }
                ...
                <div class="d-flex justify-content-between align-items-end mb-4 border-bottom pb-3">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${category == '1'}">
                            <c:if test="${not empty sessionScope.member && sessionScope.member.role_level >= 51}">
