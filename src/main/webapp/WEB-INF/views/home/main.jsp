...
<body>
	...
	<section class="impact-header text-center">
		<div class="container">
			...
			<p class="text-white-50 mb-5 animate__animated animate__fadeIn">열정적인
				축구인을 위한 데이터 커뮤니티</p>
			...
			<div class="row g-4 justify-content-center mt-2">
				<div class="col-6 col-md-3">
					<div class="stat-card">
						...
						<div>
							<span class="count-num" id="count-matches">0</span><span
				...
				<div class="col-6 col-md-3">
					<div class="stat-card">
						...
						<div>
							<span class="count-num" id="count-teams">0</span><span
								class="stat-unit">+</span>
						</div>
					</div>
				</div>
				<div class="col-6 col-md-3">
					<div class="stat-card">
						...
						<div>
							<span class="count-num" id="count-members">0</span><span
								class="stat-unit">+</span>
						</div>
					</div>
				</div>
	...
	<div class="container-fluid px-lg-5 mt-4">
		<div class="row">
			<div class="col-lg-8 col-12 offset-lg-2">
					...
					<div class="swiper main-swiper">
						<div class="swiper-wrapper">
							<div class="swiper-slide"
								style="background-image: url('${pageContext.request.contextPath}/dist/images/slide1.jpg');">
								<a href="${pageContext.request.contextPath}/introduction"
									class="align-items-center justify-content-center text-white text-center">
									<div>
							...
							<div class="swiper-slide"
								style="background-image: url('${pageContext.request.contextPath}/dist/images/slide2.jpg');">
							...
							<div class="swiper-slide"
								style="background-image: url('${pageContext.request.contextPath}/dist/images/slide3.jpg');">
				...
				<div
					class="modern-card p-4 d-flex justify-content-between align-items-center mb-4">
					<div>
					...
					<div class="d-flex gap-2">
						<button class="btn btn-outline-secondary rounded-pill"
							onclick="location.href='${pageContext.request.contextPath}/team/write'">구단
							생성</button>
						<button class="btn btn-dark rounded-pill"
							onclick="location.href='${pageContext.request.contextPath}/myteam/main'">내
							구단 이동 &rarr;</button>
					</div>
				</div>
				...
				<div class="modern-card p-4 mb-4">
					<div class="d-flex justify-content-between align-items-center mb-3">
						...
						<a
							href="${pageContext.request.contextPath}/calendar/match_calendar"
							class="text-decoration-none small text-muted">전체보기</a>
					</div>
					<div class="row g-2 text-center" id="week-calendar">
						<div class="col">
							<div class="calendar-day" id="day-0">
								<h6>MON</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
						<div class="col">
							<div class="calendar-day" id="day-1">
								<h6>TUE</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
						<div class="col">
							<div class="calendar-day" id="day-2">
								<h6>WED</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
						<div class="col">
							<div class="calendar-day" id="day-3">
								<h6>THU</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
						<div class="col">
							<div class="calendar-day" id="day-4">
								<h6>FRI</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
						<div class="col">
							<div class="calendar-day text-primary" id="day-5">
								<h6>SAT</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
						<div class="col">
							<div class="calendar-day text-danger" id="day-6">
								<h6>SUN</h6>
								<span class="fw-bold date-num"></span>
							</div>
						</div>
				...
				<div class="modern-card mercenary-section p-5 mb-5">
					<div>
						...
						<button class="btn btn-primary btn-lg rounded-pill px-5 shadow-sm"
							onclick="location.href='${pageContext.request.contextPath}/mercenary/list'">용병
							모집 / 신청하기</button>
					</div>
				</div>
