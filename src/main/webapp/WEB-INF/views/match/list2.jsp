...
function sendAjaxRequest(url,method,params,dataType,fn){
	...
	$(function(){
		...
		$('#keyword').keydown(function(e){
			if(e.key == 13||e.key=='Enter'){
				...
				$('ul.list-content').empty();
				$('ul.list-content').attr('data-pageNo',0);
		...
		function loadContent(page){
			...
			let url = '${pageContext.request.contextPath}/match/MatchComtroller';
			
			let params = {page:page, schType:'all',kwd:keyword};
